...
// E nessa rota voce coloca um 3° parametro que seria aquela função do multer que voce configuro la em cima.  1° parametro a rota, 2° parametro o callback de upload , um lidador(manda o tipo de callback que quer enviar , single e uma delas e dentro dele voce coloca uma string , usando o nome que voce espera mandar la ele envia 1 arquivo , la no postman voce envia um arquivo com a key que voce mandar aqui. pode ser um avatar ai voce coloca o nome avatar, e manda o arquivo ao lado no campo new file. Mais tem que ser o mesmo nome passado aqui na string e la na key o mesmo nome .), 3° função que executa ao acionar a rota. O callback ja acontece antes de chegar na rota , o arquivo ja vai estar la na pasta antes de chegar no arquivo.
router.post('/upload', upload.single('teste'), ApiController.uploadFile)
